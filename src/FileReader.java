...
{
    public static String USERS_FILE_NAME = "Users.txt";
    public static String FAV_USERS_FILE_NAME = "FavUsers.txt";
    ...
    { 
        ArrayList<User> list = createFavUsers(FAV_USERS_FILE_NAME, USERS_FILE_NAME);
     ...
     */
    private static ArrayList<User> createFavUsers(String favUsersFileName, String usersFileName)
    {
